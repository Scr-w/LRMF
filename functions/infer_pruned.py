...
parser.add_argument('--data', default = '/home/zhangxin/pgm/data/cifar-10-batches-py', help='path to dataset')
...
parser.add_argument('--arch', '-a', metavar='ARCH', default='resnet56', choices=model_names,
                    help='model architecture: ' + ' | '.join(model_names) + ' (default: resnet56)')
